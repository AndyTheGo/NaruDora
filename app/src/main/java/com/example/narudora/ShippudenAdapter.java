...
public class ShippudenAdapter extends ArrayAdapter<NamePage> {
    private static final String TAG = "ShippudenAdapter";
    private Context myContext;
    int myResource;

    public ShippudenAdapter(Context context, ArrayList list){
        super(context, 0, list);
    }

    public ShippudenAdapter(ShippudenActivity shippudenActivity, int name, ArrayList<NamePage> names) {
        super(shippudenActivity,0,names);
